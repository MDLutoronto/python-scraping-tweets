...
layout: "home"
description: "This tutorial demonstrates how to scrape tweets for data analysis using Python and the Twitter API."
...
* [The Twitter API](#the-twitter-application-programming-interface-api)
...
* Researchers use twitter to [predict the stock market](https://arxiv.org/pdf/1010.3003)
...
![Windows terminal with 'pip install oauth2' in the command line]({{ '/assets/images/01_0.PNG' | relative_url }})
...
![Windows terminal with 'python twitterstream.py > tweets.txt' in the command line]({{ '/assets/images/02_0.PNG' | relative_url }})
...
![File explorer with a tweets.txt file highlighted and a twitterstream.py file]({{ '/assets/images/03_0.PNG' | relative_url }})

* Wait 3\-5 minutes before you stop the program using Ctrl\-C in command line. Open the tweets file and you'll see some raw tweets similar to this:

![Contents of tweets.txt]({{ '/assets/images/04_0.PNG' | relative_url }})

 

Congratulations! You just scraped some live tweets using Python. Our next tutorial will introduce how to extract useful information from these tweets. Stay tuned!
...
Technique: [Extracting data](/technique/extracting-data) \| Tools: [Python](/tools/python)

**Date Created:** 2017\-05\-05 **Updated:** 2019\-10\-10
